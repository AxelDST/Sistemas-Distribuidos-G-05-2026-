...
### Estado y convergencia Gossip (3 miembros conocidos)
![Estado gossip](resources/estado_gossip.png)

### Escritura con quorum (W=2 — 2 confirmaciones)
![Escritura quorum](resources/escritura_quorum.png)

### Lectura con quorum (R=2)
![Lectura quorum](resources/lectura_quorum.png)

### Caída de un nodo (nodo3 detenido)
![Nodo caido](resources/nodo_caido.png)

### Tolerancia a fallos (escritura con nodo3 caído — sigue funcionando)
![Tolerancia fallos](resources/tolerancia_fallos.png)

### Lectura con quorum con nodo3 caído (PowerShell)
![Lectura tolerancia fallos](resources/lectura_tolerancia_fallos.png)

### Lectura con quorum con nodo3 caído (navegador)
![Lectura navegador tolerancia](resources/lectura_navegador_tolerancia.png)

### Caída de nodo2 (segundo nodo detenido)
![Parar nodo2](resources/parar_nodo2.png)

### Quorum no alcanzado — 503 (solo 1 nodo vivo, W=2 no se cumple)
![Quorum no alcanzado](resources/quorum_no_alcanzado.png)